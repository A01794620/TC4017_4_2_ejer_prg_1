...
def print_results(exercise_id_, number_list_, init_time_, disk_safe=True):
    """
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        # file_lines = read_from_file(f"{CommonFxs.GlobalSettings.RESOURCE_PATH}{file_to_proces}")
